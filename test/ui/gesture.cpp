...
struct SpecificView final : usagi::ui::base_view<ValueType, int, GestureParameterType> {
  ...
  bool event(typename gesture_traits::on_down_type, typename gesture_traits::offset_type) override {
    // 1
    stamp.emplace_back(1);
    return false;
  }

  void event(typename gesture_traits::on_drag_type, typename gesture_traits::offset_type) override {
    // 2
...
TEST(GestureTest, NullGestured) {
...

  {
    ...
    v.event(view::gesture_traits::on_up_type{}, typename view::offset_type{});
    v.event(view::gesture_traits::on_over_type{}, typename view::offset_type{});
    v.event(view::gesture_traits::on_out_type{}, typename view::offset_type{});
    v.event(view::gesture_traits::on_double_type{}, typename view::offset_type{});
    v.event(view::gesture_traits::on_wheel_type{}, typename view::offset_type{});
  }
}
...
TEST(GestureTest, Gestured) {
  ...
  auto v =
      ...
      usagi::ui::gestured(
          ...
          usagi::ui::on_drag(
              [&stamp](view::gesture_traits::on_drag_type, auto, auto &) { stamp.emplace_back(1); }),
          usagi::ui::on_up(
              [&stamp](view::gesture_traits::on_up_type, auto, auto &) { stamp.emplace_back(2); }),
          usagi::ui::on_over([&stamp](view::gesture_traits::on_over_type, auto, auto &) {
            stamp.emplace_back(3);
            return true;
          }),
          usagi::ui::on_out(
              [&stamp](view::gesture_traits::on_out_type, auto, auto &) { stamp.emplace_back(4); }),
          usagi::ui::on_double([&stamp](view::gesture_traits::on_double_type, auto, auto &) {
            stamp.emplace_back(5);
            return true;
          }),
          usagi::ui::on_wheel([&stamp](view::gesture_traits::on_wheel_type, auto, auto &) {
...
TEST(GestureTest, SpecializedGestured) {
  ...
  auto v = view{stamp} |
           usagi::ui::gestured(
               usagi::ui::on_up([&stamp](view::gesture_traits::on_up_type, auto, auto &) {
                 stamp.emplace_back(100);
               }),
               usagi::ui::on_drag([&stamp](view::gesture_traits::on_drag_type, auto, auto &) {
                 stamp.emplace_back(0);
               }));
