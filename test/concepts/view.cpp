...
bool ViweStaticTest()
{
  static_assert(usagi::concepts::view<ViewConcepts<int>>, "ViewConcepts<int> has view concept");
  static_assert(!usagi::concepts::view<ViewConcepts<void>>, "ViewConcepts<void> hasn't view concept");
