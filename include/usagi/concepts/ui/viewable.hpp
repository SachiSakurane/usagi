...
concept viewable =
    ...
    usagi::concepts::graphics::draw_contextable<
  ...
  {
    v.add_sub_view(
        std::declval<usagi::ui::view<typename ViewType::value_type,
                                     typename ViewType::draw_context_type>>())
    } -> std::same_as<std::add_lvalue_reference_t<usagi::ui::view<
        typename ViewType::value_type, typename ViewType::draw_context_type>>>;
};
} // namespace usagi::concepts::ui
